...
namespace NewTech.ProjectsNG.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ProjectsNGServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("NewTech.ProjectsNG", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
