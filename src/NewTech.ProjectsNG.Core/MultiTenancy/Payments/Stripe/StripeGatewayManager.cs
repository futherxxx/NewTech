...
namespace NewTech.ProjectsNG.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : ProjectsNGServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ProjectsNG";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ProjectsNGConsts.Currency;
        }
        ...
        private async Task<StripeIdResponse> CreatePlanAsync(string planId, decimal amount, string interval, string productId)
        {
            ...
            var plan = await planService.CreateAsync(new PlanCreateOptions
            {
                ...
                Interval = interval,
                Product = productId,
                Currency = ProjectsNGConsts.Currency
            });
