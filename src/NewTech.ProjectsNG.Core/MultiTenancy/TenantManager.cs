...
using NewTech.ProjectsNG.MultiTenancy.Demo;
...
namespace NewTech.ProjectsNG.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(ProjectsNGConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ProjectsNGConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
