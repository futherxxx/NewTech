...
using NewTech.ProjectsNG.Authorization.Ldap;
...
using NewTech.ProjectsNG.DashboardCustomization.Definitions;
using NewTech.ProjectsNG.Debugging;
using NewTech.ProjectsNG.DynamicEntityParameters;
using NewTech.ProjectsNG.Features;
using NewTech.ProjectsNG.Friendships;
using NewTech.ProjectsNG.Friendships.Cache;
using NewTech.ProjectsNG.Localization;
using NewTech.ProjectsNG.MultiTenancy;
using NewTech.ProjectsNG.Net.Emailing;
using NewTech.ProjectsNG.Notifications;
using NewTech.ProjectsNG.WebHooks;

namespace NewTech.ProjectsNG
{
    [DependsOn(
        typeof(ProjectsNGCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class ProjectsNGCoreModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectsNGCoreModule).GetAssembly());
        }
