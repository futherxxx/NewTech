...
{
    public class SessionAppService : ProjectsNGAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    CurrencySign = ProjectsNGConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = ProjectsNGConsts.AllowTenantsToChangeEmailSettings,
