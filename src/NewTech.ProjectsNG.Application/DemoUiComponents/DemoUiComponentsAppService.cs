...
using NewTech.ProjectsNG.DemoUiComponents.Dto;

namespace NewTech.ProjectsNG.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ProjectsNGAppServiceBase, IDemoUiComponentsAppService
    {
