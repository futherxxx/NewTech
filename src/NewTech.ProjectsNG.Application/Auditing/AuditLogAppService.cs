...
using NewTech.ProjectsNG.Auditing.Exporting;
using NewTech.ProjectsNG.Authorization;
using NewTech.ProjectsNG.Authorization.Users;
using NewTech.ProjectsNG.Dto;
using NewTech.ProjectsNG.EntityHistory;
using EntityHistoryHelper = NewTech.ProjectsNG.EntityHistory.EntityHistoryHelper;

namespace NewTech.ProjectsNG.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ProjectsNGAppServiceBase, IAuditLogAppService
    {
