...
using NewTech.ProjectsNG.Migrations.Seed;
using NewTech.ProjectsNG.Migrations.Seed.Host;
...
namespace NewTech.ProjectsNG.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ProjectsNGAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ProjectsNGDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ProjectsNGConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ProjectsNGConsts.ConnectionStringName}", constring);
        }
