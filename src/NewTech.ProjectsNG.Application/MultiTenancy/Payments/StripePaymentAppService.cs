...
using NewTech.ProjectsNG.MultiTenancy.Payments.Stripe;
using NewTech.ProjectsNG.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace NewTech.ProjectsNG.MultiTenancy.Payments
{
    public class StripePaymentAppService : ProjectsNGAppServiceBase, IStripePaymentAppService
    {
