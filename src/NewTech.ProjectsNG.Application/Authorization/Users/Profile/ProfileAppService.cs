...
using NewTech.ProjectsNG.Authorization.Users.Profile.Cache;
...
namespace NewTech.ProjectsNG.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ProjectsNGAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("NewTech.ProjectsNG",
