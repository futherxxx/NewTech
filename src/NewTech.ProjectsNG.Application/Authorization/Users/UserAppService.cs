...
using NewTech.ProjectsNG.Authorization.Permissions;
...
using NewTech.ProjectsNG.Authorization.Users.Exporting;
using NewTech.ProjectsNG.Dto;
using NewTech.ProjectsNG.Notifications;
using NewTech.ProjectsNG.Url;
using NewTech.ProjectsNG.Organizations.Dto;

namespace NewTech.ProjectsNG.Authorization.Users
{
    [AbpAuthorize(AppPermissions.Pages_Administration_Users)]
    public class UserAppService : ProjectsNGAppServiceBase, IUserAppService
    {
