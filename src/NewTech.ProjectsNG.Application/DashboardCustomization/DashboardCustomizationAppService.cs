...
namespace NewTech.ProjectsNG.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ProjectsNGAppServiceBase, IDashboardCustomizationAppService
    {
