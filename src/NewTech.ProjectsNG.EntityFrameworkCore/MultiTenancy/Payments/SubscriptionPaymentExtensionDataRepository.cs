...
using NewTech.ProjectsNG.EntityFrameworkCore.Repositories;

namespace NewTech.ProjectsNG.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : ProjectsNGRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ProjectsNGDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
