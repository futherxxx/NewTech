...
namespace NewTech.ProjectsNG.EntityFrameworkCore
{
    ...
    public class ProjectsNGEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectsNGEntityFrameworkCoreModule).GetAssembly());
        }
