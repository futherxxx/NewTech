...
using NewTech.ProjectsNG.Web.Areas.App.Models.Common.Modals;
using NewTech.ProjectsNG.Web.Areas.App.Models.OrganizationUnits;
...
namespace NewTech.ProjectsNG.Web.Areas.App.Controllers
{
    ...
    public class OrganizationUnitsController : ProjectsNGControllerBase
    {
