...
using NewTech.ProjectsNG.Web.Areas.App.Models.Languages;
...
namespace NewTech.ProjectsNG.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : ProjectsNGControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = ProjectsNGConsts.LocalizationSourceName;
            }
