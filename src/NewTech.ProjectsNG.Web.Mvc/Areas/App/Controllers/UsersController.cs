...
using NewTech.ProjectsNG.Web.Areas.App.Models.Roles;
using NewTech.ProjectsNG.Web.Areas.App.Models.Users;
...
namespace NewTech.ProjectsNG.Web.Areas.App.Controllers
{
    ...
    public class UsersController : ProjectsNGControllerBase
    {
