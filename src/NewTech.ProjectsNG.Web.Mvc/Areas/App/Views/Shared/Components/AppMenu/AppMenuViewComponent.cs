...
using NewTech.ProjectsNG.Web.Areas.App.Startup;
using NewTech.ProjectsNG.Web.Views;

namespace NewTech.ProjectsNG.Web.Areas.App.Views.Shared.Components.AppMenu
{
    public class AppMenuViewComponent : ProjectsNGViewComponent
    {
