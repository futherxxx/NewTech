...
namespace NewTech.ProjectsNG.Web.Startup
{
    ...
    public class ProjectsNGWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ProjectsNGWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectsNGWebMvcModule).GetAssembly());
        }
