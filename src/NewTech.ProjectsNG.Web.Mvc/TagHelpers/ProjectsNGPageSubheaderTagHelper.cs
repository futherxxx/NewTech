...
namespace NewTech.ProjectsNG.Web.TagHelpers
{
    ...
    public class ProjectsNGPageSubheaderTagHelper : TagHelper
    {
        ...
        public ProjectsNGPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
