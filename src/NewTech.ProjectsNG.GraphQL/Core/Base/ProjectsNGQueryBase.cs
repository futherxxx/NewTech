...
namespace NewTech.ProjectsNG.Core.Base
{
    public abstract class ProjectsNGQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ProjectsNGQueryBase(string fieldName,
