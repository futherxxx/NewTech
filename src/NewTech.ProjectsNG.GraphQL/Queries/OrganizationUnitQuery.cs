...
using NewTech.ProjectsNG.Core.Base;
using NewTech.ProjectsNG.Core.Extensions;
using NewTech.ProjectsNG.Dto;
using NewTech.ProjectsNG.Types;

namespace NewTech.ProjectsNG.Queries
{
    public class OrganizationUnitQuery : ProjectsNGQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
