...
namespace NewTech.ProjectsNG.Web.Authentication.JwtBearer
{
    public class ProjectsNGJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ProjectsNGJwtSecurityTokenHandler()
        {
