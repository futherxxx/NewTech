...
using NewTech.ProjectsNG.Web.Startup.ExternalLoginInfoProviders;

namespace NewTech.ProjectsNG.Web.Startup
{
    [DependsOn(
        typeof(ProjectsNGWebCoreModule)
    )]
    public class ProjectsNGWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ProjectsNGWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectsNGWebHostModule).GetAssembly());
        }
